...
# Best performing model from our results was Random Forest
best_model_name = results_df.loc[results_df['R2 Score'].idxmax(), 'Model']
file_path = '/content/best_salary_model.pkl'
...
if os.path.exists(file_path):
    ...
    print("Model file not found. Please ensure the saving cell was executed.")
